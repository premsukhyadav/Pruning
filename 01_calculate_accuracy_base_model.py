...
CONFIG = {
    ...
    "batch_size": 8,
    "results_dir": "results",
    "num_folders": 20,                # max number of folders/classes to process
    "imagenet_labels_path": "imagenet_classes.txt"
}

# Create results directory
os.makedirs(CONFIG["results_dir"], exist_ok=True)
detailed_csv = os.path.join(CONFIG["results_dir"], "original_detailed_report.csv")
summary_csv = os.path.join(CONFIG["results_dir"], "original_summary_report.csv")
...
# Create a minimal ImageFolder-like object
